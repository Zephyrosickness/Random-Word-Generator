...
public class display extends JFrame {
    ...
    public static void songInfoComponents(JPanel panel, JPanel wordPanel) {
        ...
        panel.add(startLabel);
         ...
         //label for uncommon letters
        //JLabel uncommonLabel = new JLabel("Uncommon Letters?");
        //uncommonLabel.setBounds(margins, (margins + (queryHeight*3)), halfTwo, queryHeight);
        //panel.add(uncommonLabel);
        ...
        //final JComboBox<String> uncommonLetter = new JComboBox<>(bool);
        //uncommonLetter.setBounds(moveForward2, (margins + (queryHeight*3)),  halfOne, queryHeight);
        //panel.add(uncommonLetter);
